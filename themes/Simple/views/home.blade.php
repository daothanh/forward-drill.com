...
@section('content')
    <div class="mainlist ui container segment">
        <section id="custom">
                ...
                <div class=" row">
                    ...
                    <div class="eight wide column">
                        ...
                        <a href="https://forward-drill.com/news/227-one-belt-and-one-road.html">
                            <p><img class="ui bordered fluid image" src="https://forward-drill.com/uploads/posts/2019-08/1566548593_1223.jpg"></p>
                     ...
                     -->
                                <a href="https://trenchlessasia.com/" target="_blank">
                                    <img src="/uploads/angl-s-logo.png">
                                </a>
                                <br><br>
                                <div>
                            ...
                            <script type="text/javascript">// <![CDATA[
                                jQuery(document).ready(function($){
                                    $('#form_container').jbform({
                                        modal: false,
                                        key: "06716079812a43b085c5116fda2fd938",
                ...
                <div class="stretched row">
                    ...
                    <div class="column">
                        <a class="ui fluid raised link teal card" href="https://forward-drill.com/hdd-rig/" alt="HDD Rig" title="Horizontal Directional Drill Rig">
                            ...
                            <div class="content">
                                <img class="ui medium image" src="/uploads/rx-11-44.jpg"/>
                    ...
                    <div class="column">
                        <a class="ui fluid raised link teal card" href="https://forward-drill.com/multifunctional-slanted-drilling-equipment/">
                            ...
                            <div class="content">
                                <img class="ui medium image" src="/uploads/nnb.jpg"/>
                    ...
                    <div class="column">
                        <a class="ui fluid raised link teal card" href="/coring-drill-equipment/">
                            <div class="content">
                                <div class="header">Coring Drill Rig</div>
                            </div>
                            <div class="content">
                                <img class="ui medium image" src="/uploads/coring-drill.jpg"/>
                    ...
                    <div class="column">
                        <a class="ui fluid raised link teal card" href="https://forward-drill.com/forward-groupwater-well-drill-equipment/">
                            ...
                            <div class="content">
                                <img class="ui medium image" src="/uploads/water.jpg"/>
                    ...
                    <div class="column">
                        <a class="ui fluid raised link teal card" href="https://forward-drill.com/multifunction-top-drive-drilling-equipment/">
                            ...
                            <div class="content">
                                <img class="ui medium image" src="/uploads/multifunctional.jpg"/>
                    ...
                    <div class="column">
                        <a class="ui fluid raised link teal card" href="https://forward-drill.com/drill-tools/">
                            ...
                            <div class="content">
                                <img class="ui medium image" src="/uploads/drill-tools.jpg"/>
                ...
                <div class="row">
                    ...
                    <div class="column">
                        <a href="https://forward-drill.com/news/226-forward-in-trenchless-asia-2019-jakarta-indonesia.html">
                            <p><img class="ui bordered fluid image" src="https://forward-drill.com/uploads/posts/2019-07/thumbs/1563529810_whatsapp-image-2019-07-17-at-12.26.26.jpeg"></p>
                    ...
                    <div class="column">
                        <a href="https://forward-drill.com/news/225-the-most-interesting-exhibitions-in-the-field-of-hdd.html">
                            <p><img class="ui bordered fluid image" src="https://forward-drill.com/uploads/posts/2019-07/1562078115_forvard-mal.png"></p>
